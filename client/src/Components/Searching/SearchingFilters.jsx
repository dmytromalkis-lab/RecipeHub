  ...
  return (
    <aside className="search-filters-root">
      <div className="sf-header">
        <h4>Filters</h4>
        <button className="sf-reset" type="button" onClick={reset}>Reset</button>
      </div>
      ...
      <div className="sf-group">
        <label className="sf-label">Show recipes without:</label>
        <input
          className="sf-input"
          placeholder="Enter ingredients..."
      ...
      <div className="sf-block">
        <div className="rc-category">
          <h3 className="rg-title" style={{ margin: 0 }}>Difficulty:</h3>
          <div style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
            <select className="rcat-select" value={difficulty} onChange={(e) => setDifficulty(e.target.value)}>
        ...
        <div className="sf-block-category">
          <RecipeCategory value={categoryId} onChange={(val) => setCategoryId(val)} />
        </div>
      </div>
    </aside>
  );
